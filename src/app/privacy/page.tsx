  ...
  return (
    <main className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 py-16">
        <h1 className="text-4xl font-black tracking-tight mb-2 text-[var(--text)]">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <p>The API fetches data from <a href="https://omegascans.org" className="text-[var(--accent)] hover:underline" target="_blank" rel="noopener noreferrer">OmegaScans</a>. No user data is transmitted to the upstream source.</p>
          </section>
          ...
          <section>
            ...
            <p>For privacy-related questions, please open an issue on <a href="https://github.com/Shineii86/OmegaAPI" className="text-[var(--accent)] hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>.</p>
          </section>
        </div>
      </div>
    </main>
