/**
 * ┌─────────────────────────────────────────────────────────────┐
 * │  OmegaAPI — SVG Icon Library                               │
 * │  Author : Sʜɪɴᴇɪ Nᴏᴜᴢᴇɴ                                   │
 * │  License: MIT                                              │
 * │  Module : src/components/icons.tsx                          │
 * └─────────────────────────────────────────────────────────────┘
 *
 * Lightweight SVG icon components used across the frontend.
 * Each icon is a standalone React component with a configurable `size` prop.
 *
 * Design rules:
 *   - All icons render at 24×24 viewBox by default
 *   - Stroke-based icons use strokeWidth="2"
 *   - Fill icons (IconStar, IconGrid, etc.) use fill="currentColor"
 *   - Colors are inherited from parent via CSS currentColor
 */
...
/** Filled star variant (same as IconStar, aliased for clarity) */
...
/** Open book icon (chapters, reading) */
...
/** Bookmark icon (save/bookmark series) */
...
/** Right chevron (navigation, breadcrumbs) */
...
/** Left chevron (back navigation, pagination) */
...
/** Down chevron (dropdowns, expandable sections) */
...
export function IconArrowLeft({ size = 16 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" /></svg>;
}
...
/** Magnifying glass (search input, search overlay trigger) */
...
/** Grid view icon (4-square grid layout) */
...
/** List view icon (3 horizontal bars) */
...
/** Inbox icon (empty state placeholder) */
export function IconInbox({ size = 48 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg>;
}

/** Warning triangle (alerts, error states) */
export function IconAlertTriangle({ size = 32 }: { size?: number }) {
...
/** Bug icon (error reporting, support page) */
export function IconBug({ size = 24 }: { size?: number }) {
...
export function IconLightbulb({ size = 24 }: { size?: number }) {
...
/** Heart with pulse (health check, monitoring) */
export function IconHeartPulse({ size = 20 }: { size?: number }) {
...
/** Signal bars (connectivity, API status) */
export function IconSignal({ size = 20 }: { size?: number }) {
...
/** Open lock (zero-auth, public access) */
export function IconLockOpen({ size = 20 }: { size?: number }) {
...
export function IconDiamond({ size = 20 }: { size?: number }) {
...
/** Zap (fast, instant) */
export function IconZap({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>;
}

/** Globe (worldwide, public) */
...
export function IconServer({ size = 20 }: { size?: number }) {
...
/** Bar chart (statistics, analytics) */
...
/** Copy icon (clipboard copy button) */
...
/** Checkmark (success, confirmation, copied state) */
...
/** Code brackets (developer docs, code blocks) */
...
/** Sparkles (featured content, highlights) */
export function IconSparkles({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3l1.912 5.813a2 2 0 0 0 1.275 1.275L21 12l-5.813 1.912a2 2 0 0 0-1.275 1.275L12 21l-1.912-5.813a2 2 0 0 0-1.275-1.275L3 12l5.813-1.912a2 2 0 0 0 1.275-1.275L12 3z" /></svg>;
}

// ---- FEATURE: HEART ----

/**
 * Heart icon with configurable fill.
 *
 * @param fill - CSS fill value ("none" for outline, "currentColor" for filled)
 *
 * NOTE: Used for bookmarks (filled/unfilled) and footer heartbeat animation.
 */
export function IconHeart({ size = 20, fill = 'none' }: { size?: number; fill?: string }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" /></svg>;
}

// ---- FEATURE: LAYERS ----

/** Layers (stacked content, architecture) */
export function IconLayers({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></svg>;
}

/** Terminal (CLI, developer tools) */
export function IconTerminal({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg>;
}

/** Shuffle (random, sort modes) */
...
/** Close/X (dismiss, close modal, cancel) */
...
/** Fire (trending, hot series) */
export function IconFire({ size = 20 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" /></svg>;
}
...
/** Clock (reading history, time remaining) */
